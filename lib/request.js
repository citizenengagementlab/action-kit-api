 ...
 * @param {string} username - ActionKit user with Request access
 * @param {string} password - Password for user
 * @constructor
 */
var Request = function(domain, username, password) {
    this.domain = domain;
...
/**
 * Get a resource or collection from ActionKit API
 *
 ...
 * @param callback
 */
Request.prototype.getAll = function(path, options, callback) {
    if(typeof options === 'function') {
        callback = options;
        options = {};
    }
 ...
 * @param callback
 */
Request.prototype.create = function(path, data, callback) {
    var options = {
        uri: this.baseURI + path,
        method: 'POST',
        json: data
 ...
 * @param callback
 */
Request.prototype.update = function(path, data, callback) {
    var options = {
        uri: this.baseURI + path,
        method: 'PUT',
        headers: headers,
 ...
 * @param callback
 */
Request.prototype.delete = function(path, callback) {
    var options = {
        uri: this.baseURI + path,
        method: 'DELETE',
        headers: headers
